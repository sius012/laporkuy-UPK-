            ...
            try {
              ...
              //Penugasan::where('id_penugasan',$req->id_pengaduan)->update(["keterangan_admin"=>$input["id_pengaduan"]]);
                ...
                ChangeLog::create([
                  ...
                  $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Laporan Diverifikasi", "isi"=>$pengaduan->judul .":" ."Laporan disudah diverifikasi oleh admin"]);
    ...
    public function updatePetugas(Request $req){
        ...
        try {
            ...
            ChangeLog::create([
             ...
             $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Petugas Diperbarui", "isi"=>$pengaduan->judul .":" ."Petugas telah diperbarui oleh"]);
