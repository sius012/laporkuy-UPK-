...
class PengaduanController extends Controller
{
    ...
    public static function getSingle(Request $req){
        $pengaduan = Pengaduan::with("jenis")->with("lampiran")->with("pelapor", "penugasan.tanggapan.sender","jenis_pengaduan")->with("penugasan.petugas_lapangan.users")->find($req->id_pengaduan);
        //dd($pengaduan);
        return $pengaduan;
    }
