...
class PengaduanController extends Controller
{
            ...
            try {
              ...
              //Penugasan::where('id_penugasan',$req->id_pengaduan)->update(["keterangan_admin"=>$input["id_pengaduan"]]);
                ...
                ChangeLog::create([
                  ...
                  $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Pengaduan Diverifikasi", "isi"=>"<b>".$pengaduan->judul ."</b> ".":" ."Pengaduan disudah diverifikasi oleh admin"]);
                
                  //notif untuk petugas
                  foreach($input["petugas"] as $j => $ptg){
                        $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Pengaduan Masuk", "isi"=> "<b>".$pengaduan->judul ."</b> ".":" ."Admin menambahkan tugas untuk anda"]);
                  }
        ...
        try {
            ...
            foreach($req->petugas as $k => $ptg){
                if(!in_array($ptg, $req->petugas)){
                    $notif = Notification::create(["id_user"=>$ptg, "judul"=>"Penugasan Masuk", "isi"=> "<b>".$pengaduan->judul ."</b> ".":" ."Admin menambahkan tugas untuk anda"]);
                }
            }
    ...
    public function ubahStatus(Request $req){
        ...
        $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Pengaduan "<div class="1ti"></div>, "isi"=>$pengaduan->judul .":" .$keterangan]);
