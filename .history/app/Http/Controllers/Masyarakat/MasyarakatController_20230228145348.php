...
class MasyarakatController extends Controller
{
    ...
    public function pengaduansaya(Request $req){
        ...
        if($req->filled('dari') and $req->filled('sampai')){
            $pengaduan = $pengaduan->whereBetween("tanggal",[$req->dari." ".date('h:i:s'), $req->sampai." ".date('h:i:s')]);
        }


       // dd($pengaduan);
        return view("masyarakat.laporansaya", ["transparent"=>false, "pengaduan"=>$pengaduan, "jenis_pengaduan"=>$jp->get()]);
    }
}
