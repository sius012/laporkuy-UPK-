...
class MasyarakatController extends Controller
{
    ...
    public function pengaduansaya(Request $req){
        ...
        $pengaduan = $pengaduan->where("id_pelapor", $id_pelapor)->with('pelapor')->with('penugasan.tanggapan.sender', function($q){
            $p->where()
        })->with('penugasan.petugas_lapangan.petugas')->orderBy("tanggal", "desc")->with('log.user');
