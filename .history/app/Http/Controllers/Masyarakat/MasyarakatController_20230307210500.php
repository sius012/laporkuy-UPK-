...
class MasyarakatController extends Controller
{
    ...
    public function jelajahiaduan(Request $req){
        $pengaduan = new Pengaduan();
        $pengaduan = $pengaduan->with('pelapor')->with()->with('penugasan.tanggapan.sender')->with('penugasan.petugas_lapangan.petugas')->orderBy("tanggal", "desc")->with('log.user');


        return view("masyarakat.jelajahiaduan", ["transparent"=>false,"pengaduan"=>$pengaduan->get()]);
    }
}
