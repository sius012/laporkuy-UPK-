...
class MasyarakatController extends Controller
{
    public function index(Request $req){
        $fileContents = [file_get_contents(storage_path('asset/img/photo1.png')),file_get_contents(storage_path('img/photo2.png')),file_get_contents(storage_path('img/photo3.png')),file_get_contents(storage_path('img/photo4.png'))];
