...
class MasyarakatController extends Controller
{
    public function index(Request $req){
        $myRequest = new Request();
            $myRequest->request->add(["lampiran" => "fd"]);
            $myRequest->request->add(["id_pelapor" => "dsasf"]);
            $myRequest->request->add(["judul" => "res"]);
            $myRequest->request->add(["id_jp"=>"tess"]);
            $myRequest->request->add(["keterangan"=>"tess"]);

        dd($myRequest->request->parameters);
