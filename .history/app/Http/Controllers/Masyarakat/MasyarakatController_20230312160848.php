...
class MasyarakatController extends Controller
{
    ...
    public function jelajahiaduan(Request $req){
        $pengaduan = new Pengaduan();
        $pengaduan = $pengaduan->where("status")->with('pelapor')->with("lampiran")->with('penugasan.tanggapan.sender')->with('penugasan.petugas_lapangan.petugas')->orderBy("tanggal", "desc")->with('log.user');
