...
class PengaduanController extends Controller
{
    ...
    public function sendtanggapan(Request $req){
        $this->sendtanggapanBase($req->pesan, $req->id_pemih)
    }
    public function sendtanggapanBase($pesan, $id_penugasan){
        $pesan = $req->pesan;
    ...
    public function ubahStatus(Request $req){
        ...
        if($status == "Dibatalkan"){
            ...
            $this->sendtanggapan($id_penugasan->id_penugasan, )
        }
    ...
    public function hapusPengaduan($id_pengaduan,$keterangan){
        $datapengaduan = Pengaduan::find($id_pengaduan);
        
        $notif = Notification::create(["id_user"=>$datapengaduan->id_pelapor, "judul"=>"Laporan Ditolak", "keterangan"=>$keterangan,"status"=>"belum"]);
    }
}
