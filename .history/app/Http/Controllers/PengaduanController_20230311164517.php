        ...
        try {
            ...
            foreach($penugasan->petugas_lapangan as $j => $ptg){
                if(!in_array($ptg->id_petugas, $req->petugas)){
                    $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Penugasan Batal", "isi"=> "<b>".$pengaduan->judul ."</b> ".":" ."Anda sekarang bukan petugas"]);
                }
            }

            foreach($req->petugas as $k => $ptg){
                if(in_array($ptg, $req->petugas)){
                    $notif = Notification::create(["id_user"=>$pengaduan->id_pelapor, "judul"=>"Penugasan Masuk", "isi"=> "<b>".$pengaduan->judul ."</b> ".":" ."Admin menambahkan tugas untuk anda"]);
                }
            }
