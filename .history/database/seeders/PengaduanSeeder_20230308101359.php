...
class PengaduanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $lokasi = [
            Jl. Merdeka No. 10, Kelurahan Sukamaju, Kecamatan Cibinong, Kabupaten Bogor, Jawa Barat
(Kota: Cibinong, Desa: Sukamaju)

Jl. Diponegoro No. 50, Kelurahan Kebonbaru, Kecamatan Bekasi Selatan, Kota Bekasi, Jawa Barat
(Kota: Bekasi, Desa: Kebonbaru)

Jl. Raya Magelang No. 73, Kelurahan Purwomartani, Kecamatan Kalasan, Kabupaten Sleman, Daerah Istimewa Yogyakarta
(Kota: Sleman, Desa: Purwomartani)

Jl. Veteran No. 25, Kelurahan Mojo, Kecamatan Magetan, Kabupaten Magetan, Jawa Timur
(Kota: Magetan, Desa: Mojo)

Jl. Raya Kuta No. 88, Kelurahan Kuta, Kecamatan Kuta, Kabupaten Badung, Bali
(Kota: Badung, Desa: Kuta)
        ...
        for ($i = 0; $i < $jumlahPengaduan; $i++) {
            ...
            $pengaduan->tambahGeneral($params);
