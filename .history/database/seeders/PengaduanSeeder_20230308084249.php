    ...
    public function run()
    {
       ...
       , "Kami mengajukan keluhan terhadap perusahaan besar yang beroperasi di daerah kami. Perusahaan tersebut seringkali mengabaikan hak-hak pekerja dan melakukan praktik-praktik yang merugikan para pekerja, seperti pengupahan yang rendah, jam kerja yang terlalu lama, dan ketidakamanan kerja. Kami membutuhkan perlindungan yang lebih baik dari pemerintah untuk melindungi hak-hak kami sebagai pekerja."
         ...
         $contohKeterangan_admin = [
            "Mohon segera melaporkan laporan proyek mingguan besok pukul 09.00 WIB di ruang rapat.",

,"Harap segera menyelesaikan tugas ini dalam waktu satu jam dan laporkan hasilnya pada saya melalui email."

,"Anda diminta untuk mempersiapkan presentasi proyek besok dan menyampaikannya di depan tim."

"Silakan menyusun laporan keuangan bulanan dan menyerahkannya kepada direktur paling lambat t,anggal 10 setiap bulannya."

"Mohon segera mengevaluasi performa tim dan menyusun rekomendasi untuk meningkatkan produktivitas kerja."

"Diharapkan untuk menyusun proposal proyek dengan jelas dan detail serta menyampaikannya pada rapat koordinasi besok."

"Tolong segera mengirimkan resume dan portofolio kerja Anda melalui email ke alamat yang sudah disediakan."

"Anda diinstruksikan untuk mengikuti pelatihan dan sertifikasi yang diselenggarakan oleh perusahaan dalam waktu dekat."

"Mohon segera mengirimkan laporan penjualan bulanan dan analisis pasar pada direktur paling lambat tanggal 5 setiap bulannya."

"Diharapkan untuk memenuhi target penjualan bulanan dan melaporkan hasilnya pada tim dalam rapat mingguan."
         ]
