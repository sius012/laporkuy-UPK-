...
class PengaduanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i = 0;$i < $jumlahPengaduan; $i++){
            ...
            //lampiran =
            $fileContents = [file_get_contents(storage_path('img/photo1.png')),file_get_contents(storage_path('img/photo2.png')),file_get_contents(storage_path('img/photo3.png'))];
