...
class PengaduanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i = 0;$i < $jumlahPengaduan; $i++){
            ...
            //lampiran =
            $fileContents = [file_get_contents(storage_path('img/photo1.png')),file_get_contents(storage_path('img/photo2.png')),file_get_contents(storage_path('img/photo3.png')),file_get_contents(storage_path('img/photo4.png'))];

            $fileContents = 
        [storage_path('asset/img/photo1.png'),storage_path('asset/img/photo2.png'),storage_path('asset/img/photo3.jpg'),];

            $myRequest = new Request();
            $myRequest->request->add(["lampiran"=>$fileContents]);
