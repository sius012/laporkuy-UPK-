        ...
        success: function(data){
          ...
          // alert(images);
           ...
           // console.log(data);
            ...
            $(".container-maps").html(`
            <div class="mapouter"><div class="gmap_canvas"><iframe width="770" height="510" id="gmap_canvas" src="https://maps.google.com/maps?q=kebumen jawa tengah&t=&z=10&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://2yu.co">2yu</a><br><style>.mapouter{text-align:right;height:510px;width:770px;}</style><a href="https://embedgooglemap.2yu.co">html embed google map</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:510px;}</style></div></div>
            `);
...
function readImage(input,output) {
  ...
  function tampilkanpetugas(data){
    ...
    if(data==null){
        ...
        return `
            <tr>
                <td><input type='hidden' name="petugas[]" class="petugas-id-cont" value="${e['petugas']['id']}">${e['petugas']['name']}</td>
                <td>
                    <select class="form-control" class="jabatan-select" name="jabatan[]">
                        <option value='Anggota' ${e['jabatan'] == "Anggota" ?  "selected" : ""}>Anggota</option>
                        <option value='Ketua' ${e['jabatan'] == "Ketua" ?  "selected" : ""}>Ketua</option>
                    </select>
                </td>
