        ...
        <div class="col-sm-8">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control-plaintext" id="inputNis" placeholder="Alamat" value="{{Auth::user()->alamat}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="alamatPassword" class="col-sm-2 col-form-label">Alamat</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control-plaintext" id="inputNis" placeholder="password" value="{{Auth::user()->alamat}}">
                    </div>
                </div>
            </form>
        </div>
