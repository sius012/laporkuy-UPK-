                              ...
                              <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                  ...
                                  <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="keteranganakhir{{$i}}" role="tabpanel" aria-labelledby="contact-tab">
                                     
                                    </div>
                                    <div class="tab-pane fade" id="log{{$i}}" role="tabpanel" aria-labelledby="contact-tab">
