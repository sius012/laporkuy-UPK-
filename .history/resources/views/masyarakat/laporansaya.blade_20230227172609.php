                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="keteranganakhir-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="keteranganakhir" aria-selected="false">Keterangan Akhir</a>
                                        </li>
                                        <li class="nav-item">
                                      ...
                                      <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="keterangan" role="tabpanel" aria-labelledby="home-tab">...</div>
                                        <div class="tab-pane fade show active" id="respon" role="tabpanel" aria-labelledby="home-tab">...</div>
                                        <div class="tab-pane fade show active" id="petugas" role="tabpanel" aria-labelledby="home-tab">...</div>
