                            ...
                            <div class="card-header" id="headingOne">
                              <h5 class="mb-0">
                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapse{{$i}}" aria-expanded="true" aria-controls="collapseOne">
                                  <i class="fas fa-list"></i> {{$pn->judul_pengaduan}} <span class="badge bg-primary">{{$pn->status}}</span>
                                </button>
                              </h5>
                            </div>
                                  ...
                                  <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="contact{{$i}}" role="tabpanel" aria-labelledby="contact-tab">
                                      ...
                                      @foreach($pn->penugasan->petugas_lapangan as $j => $pl)
                                        <li class="list-group-item">{{$pl->petugas->name}} <span class="badge bg-primary">{{$pl->s}}</span>  </li>
                                      @endforeach
                                       </ul>
                                      @endif
                                    </div>
