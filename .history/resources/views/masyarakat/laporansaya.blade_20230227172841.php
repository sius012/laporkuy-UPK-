                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                      ...
                                      <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="keterangan" role="tabpanel" aria-labelledby="home-tab">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque quaerat nulla nostrum, quasi enim dolorem ad accusantium fugiat perferendis voluptate, praesentium veniam debitis, ratione unde odit accusamus dolor. Praesentium architecto ipsam, nesciunt perspiciatis beatae id itaque ea necessitatibus eos quia est blanditiis reprehenderit amet temporibus. Soluta odio cum sunt sapiente non consequatur fuga veritatis. Libero animi minima porro reiciendis odit aliquam eos, odio atque nostrum sequi repellat earum neque ipsum, tempore ducimus voluptate? Odio, expedita ut fuga saepe nihil illum commodi beatae repudiandae in dolore quisquam aperiam! Illo incidunt doloremque dolore assumenda doloribus eveniet deleniti nam maxime ratione necessitatibus? Fuga.</div>
                                        <div class="tab-pane fade show" id="respon" role="tabpanel" aria-labelledby="home-tab">Respon</div>
                                        <div class="tab-pane fade show" id="petugas" role="tabpanel" aria-labelledby="home-tab">Petugas</div>
