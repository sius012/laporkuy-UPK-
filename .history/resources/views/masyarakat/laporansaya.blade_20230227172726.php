                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                      ...
                                      <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="keteranganakhir" role="tabpanel" aria-labelledby="home-tab">Keterangan Akhir</div>
                                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">Log</div>
                                      </div>
                                </div>
                            </div>
