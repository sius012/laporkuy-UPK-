                            ...
                            <div class="card-header" id="headingOne">
                              <h5 class="mb-0">
                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapse{{$i}}" aria-expanded="true" aria-controls="collapseOne">
                                   <p><i class="fas fa-tasks-alt m-2 "></i>{{$pn->judul_pengaduan}} <span class="badge bg-primary">{{$pn->status}}</span></p> 
                                </button>
                              </h5>
                            </div>
                            ...
                            <div id="collapse{{$i}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                              <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                      <a class="nav-link" id="keteranganakhir-tab" data-toggle="tab" href="#keteranganakhir{{$i}}" role="tab" aria-controls="keterangan-akhie" aria-selected="false">Keterangan Akhir</a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link" id="log-tab" data-toggle="tab" href="#log{{$i}}" role="tab" aria-controls="keterangan-akhie" aria-selected="false">Log</a>
                                    </li>
                                  </ul>
                                  <div class="tab-content" id="myTabContent">
                                      ...
                                      <div class="card direct-chat direct-chat-primary">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <span title="3 Newd Messages" class="badge badge-primary">3</span>
                                            ...
                                            <form action="#" method="post">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append">
                                                        <button type="button" class="btn btn-primary-lk"
                                    ...
                                    <div class="tab-pane fade" id="keteranganakhir{{$i}}" role="tabpanel" aria-labelledby="keteraganakhir-tab">
                                     
                                    </div>
                                    <div class="tab-pane fade" id="log{{$i}}" role="tabpanel" aria-labelledby="log-tab">
                                      
                                        <ul class="list-group-item">
                                          @foreach($pn->log as $i => $log)
                                            <li class="list-group-item">{{$log->tanggal}} <b>{{$log->user->name}} {{$log->keterangan_log}}</b></li>
                                          @endforeach
                                        </ul>
                                    </div>
                                  </div>
                              ...
                              <div class="card-footer">
                                <button class="btn btn-primary-lk"><i class="fas fa-image"></i></button>
                              </div>
                            </div>
                          </div>    
                        @endforeach
