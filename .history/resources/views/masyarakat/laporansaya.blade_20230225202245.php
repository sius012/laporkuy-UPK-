                            ...
                            <div class="card-header" id="headingOne">
                              <h5 class="mb-0">
                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapse{{$i}}" aria-expanded="true" aria-controls="collapseOne">
                                  <i class="fas fa-list"></i> {{$pn->judul_pengaduan}}
                                </button>
                              </h5>
                            </div>
                                                ...
                                                @foreach($pn->penugasan->tanggapan as $j => $p)
                                                  <div class="direct-chat-msg @if($p->sender->id == auth()->user()->id)  right @endif" >
                                                    <div class="direct-chat-infos clearfix">
                                                        <span class="direct-chat-name @if($p->sender->id == auth()->user()->id)float-right @else flo@endif">{{$p->sender->name}}</span>
                                                        <span class="direct-chat-timestamp float-right">{{$p->tanggal}}</span>
                                                    </div>
                                                    <!-- /.direct-chat-infos -->
