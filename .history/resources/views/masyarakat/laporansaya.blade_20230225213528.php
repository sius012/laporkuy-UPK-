                            ...
                            <div id="collapse{{$i}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                              <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                      <a class="nav-link" id="contact-tab" data-toggle="tab" href="#keteranganakhir{{$i}}" role="tab" aria-controls="keterangan-akhie" aria-selected="false">Keterangan Akhir</a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link" id="contact-tab" data-toggle="tab" href="#log{{$i}}" role="tab" aria-controls="keterangan-akhie" aria-selected="false">Keterangan Akhir</a>
                                    </li>
                                  </ul>
