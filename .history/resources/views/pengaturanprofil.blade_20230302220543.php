...
<div class="container card p-3 my-5">
    <div class="row">
        <div class="col-sm-4 d-flex">
            ...
            <button class="btn btn-primary-lk position-absolute btn-image m-auto" style="top: 70%; left: 20%"><i class="fa fa-image"></i></button>
        ...
        <div class="col-sm-8">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nik" readonly class="form-control" id="inputNis" placeholder="Belum Dilengkapi">
                    </div>
                    <div class="col">
                        <a href="#" class="btn-edit"><i class="fa fa-edit"></i></a>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" accept="image/*"readonly class="form-control-plaintext" id="inputNis" placeholder="password" value="12345678">
                    </div>
                </div>
