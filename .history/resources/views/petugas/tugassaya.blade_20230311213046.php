        ...
        <div class="col">
            <div class="card card-main-task p-3" style="height: 90vh; overflow-y: scroll">
                <div class="row">
                    ...
                    <div class="col"><label class="badge {{Laporkuy::renderSpan($color[$i]}}">3</label></div>
                </div>
               
                @foreach($ps as $j => $pss)

                <div class="card m-1 btn-info-laporan card-task" data-bs-toggle="modal" data-bs-target="#modal-laporan"
