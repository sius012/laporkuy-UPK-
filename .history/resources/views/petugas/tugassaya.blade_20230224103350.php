...
<div class="modal fade" id="modal-selesai" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 100 !important" >
    <form action="{{url('konfirmasi-selesai')}}" method="post" enctype="multipart/form-data">
    @csrf
