        ...
        <div class="col">
            <div class="card card-main-task p-3" style="height: 90vh; overflow-y: scroll">
                <div class="row">
                    ...
                    <div class="col"><label class="badge {{$color[$i]}}">3</label></div>
                </div>
               
                @foreach($ps as $j => $pss)

                <div class="card m-1 btn-info-laporan card-task p-3" data-bs-toggle="modal" data-bs-target="#modal-laporan"
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 py-3">
                            ...
                            <p class="">{{Laporkuy::trunc($pss->keterangan,10)}}</p>
                            <div class="row">
