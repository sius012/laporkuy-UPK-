    ...
    <div class="row" style="height: 100vh">
        @foreach($pengaduan as $i => $ps)
            <div class="col">
                ...
                @foreach($ps as $j => $pss)
                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-laporan" class="btn-info-laporan" value="{{$pss->id_pengaduan}}" uri="{{url('getsinglepengaduan')}}">
                        <div class="card m-1">
                            <div class="row">
                                <div class="col-4"><img src="{{$pss->lampiran[0]->isi_lampiran}}" alt="" width="80px" height="80"></div>
                                <div class="col-8">
                                    <label>{{$pss->judul_pengaduan}}</label>uri="{{url('getsinglepengaduan')}}"
