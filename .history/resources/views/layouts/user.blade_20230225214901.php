...
<head>
    ...
    <link rel="stylesheet" href="https://kit.fontawesome.com/ce6d330fb6.css" crossorigin="anonymous">
...
<body>
    <!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark shadow-5-strong @if(isset($transparent))@if($transparent == true )position-absolute navbar-lk m-1 @else   @endif  @else position-absolute  navbar-lk m-1 @endif  w-100">
    <!-- Container wrapper -->
