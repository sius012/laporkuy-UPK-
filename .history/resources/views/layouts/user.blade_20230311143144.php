                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex  justify-content-end">
                  @if(Auth::check())
                    ...
                    <li class="nav-item">
                        <div class="dropdown ">
                            @if(Auth::check())
                            <button class="btn   mx-3 mt-2@if(!isset($transparent)) mt-auto btn-white-lk @else btn-primary-lk @endif dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{Auth::user()->name}}
                            </button>
                            @else
