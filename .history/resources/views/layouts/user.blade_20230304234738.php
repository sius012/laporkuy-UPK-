...
<nav class="navbar navbar-expand-lg navbar-light shadow first-letter: @if(isset($transparent))@if($transparent == true )position-absolute navbar-lk-trans m-1 @else   @endif  @else position-absolute  navbar-lk-trans m-1 @endif  w-100">
    ...
    <div class="container-fluid">
      <!-- Navbar brand -->
      <a class="navbar-brand @if(isset($transparent)) @if($transparent == false) colored-brand @endif @endif" href="#">Laporkuy</a>
      ...
      <div class="collapse navbar-collapse container-fluid" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link @if(isset($transparent))  @if($transparent == false) nav-link-lk @endif @endif" href="#">Jelajahi Laporan</a>
          </li>
          <!-- Navbar dropdown -->
