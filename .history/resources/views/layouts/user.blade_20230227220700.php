    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link nav-link-lk active" href="{{route('user.home')}}" aria-current="page" >Beranda</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-lk" href="{{route('pengaduan.list.user')}}">Laporan Saya</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-lk" href="#">Jelajahi Laporan</a>
          </li>
          <!-- Navbar dropdown -->
