                  ...
                  @if(Auth::check())
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-toggle="dropdown" href="#">
                            ...
                            <span class="badge badge-warning navbar-badge dd-notif-span">15</span>
                        </a>
                    ...
                    <li class="nav-item">
                        <div class="dropdown ">
                            @if(Auth::check())
                            <button class="btn   mx-3 mt-2 @if(!isset($transparent)) btn-white-lk @else btn-primary-lk @endif dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{Auth::user()->name}}
                            </button>
                            @else
                            <a href="{{route('login')}}"><button class="btn btn-white-lk mx-3 mt-2 btn-sm"><i class="fas fa-login"></i> <b> Masuk</b></button></a>
                            @endif
          ...
          success: function(data){
              ...
              let notif = data.map(function(e){
                return `<a href="#" class="dropdown-item">
                                ...
                                <span class="float-right text-muted text-sm">${getTimeDifference(e["created_ats"])}</span>
                                <p></p>
                            </a>`;
              })
