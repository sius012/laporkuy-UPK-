...
<head>
    ...
    <title>Laporkuy: @yield("title")</title>
...
<body class="bg-auth">
    <div class="container">
        <div class="card card-auth p-3" style="margin-top: 5%; mb-5">
            <div class="row">
                <div class="col-md">
                    <img src="{{asset('img/laporkuy-icon.png')}}" alt="" class="mb-5">

                    <div class="container d-flex">
                        <img class="m-auto" src="{{asset('img/auth-ilustration.png')}}" alt=""><br>
                        
                    </div>
                    <div class="row">
                        <p class="text-center text-auth m-5"> Buat Laporan Pengaduan dengan
