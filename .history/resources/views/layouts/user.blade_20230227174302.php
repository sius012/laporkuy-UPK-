...
<body>
    <!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-light shadow first-letter: @if(isset($transparent))@if($transparent == true )position-absolute navbar-lk m-1 @else   @endif  @else position-absolute  navbar-lk m-1 @endif  w-100">
    <!-- Container wrapper -->
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" href="{{route()}}" aria-current="page" >Beranda</a>
          </li>
          <li class="nav-item">
