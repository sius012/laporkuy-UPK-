...
<body>
    <!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark shadow-5-strong @if(isset($transparent))@if($transparent == true )position-absolute @else   @endif  @else position-absolute  @endif navbar-lk m-1 w-100">
    <!-- Container wrapper -->
