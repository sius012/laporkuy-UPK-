...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light elevation-4" >
    <!-- Brand Logo -->
    <div class="container">
      <img src="{{asset('img/laporkuy-icon.png')}}" alt="" class="m-3 brand-lk">
    </div>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">  
        <div class="info">
          <a href="#" class="d-block nav-link">{{Auth::user()->name}}</a>
      ...
      <nav class="mt-2">
        ...
        @foreach(Laporkuy::renderNav() as $rs)
            ...
            <li class="nav-item">
              <a href="{{$rs['url']}}" class="nav-link @if(url()->current() == $rs['url']) active @endif">
