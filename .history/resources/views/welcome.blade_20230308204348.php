...
<div class="jumbotron bg-primary-lk">
    <div class="row">
        <div class="col-md-7">
            ...
            <p class="lead">
                <a class="btn btn-white-lk btn-lg" href="#" role="button" onclick="scrollToDiv()">Buat Pengaduan</a>
            </p>
        </div>
        <div class="col-md-5">
...
<div class="container my-3">
    <h3 class="text-center m-4">
        Mengapa Harus Laporkuy?
    </h3>
    <div class="row">
        <div class="col-md-4">
            <div class="card card-info">
                <i class="fa fa-tachometer"></i>
                <h3>Cepat dan Gesit</h3>
                <p>Laporkuy selalu melakukan follow-up dengan cepat</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-info">
                ...
                <p>Laporkuy menyiadakan fitur yang mudah diakses.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-info">
                ...
                <h3>Terintegrasi</h3>
                <p>Laporkuy terintegrasi denga baik</p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#myDiv")[0].scrollIntoView({behavior: "smooth", block: "start", inline: "nearest"});
  });
    });

    function scrollToDiv() {

        var div = document.getElementById("card-pengaduan");
        div.scrollIntoView({
            behavior: "smooth"
            , block: "start"
            , inline: "nearest"
