...
$(function() {
    $("#example").DataTable({
        ...
        "lengthChange": false,
        "autoWidth": false,
        "buttons": ["copy", "csv", "excRoute::post("/send-tanggapan",[App\Http\Controllers\PengaduanController::class, "sendtanggapan"])->name("laporan.send-tanggapan");el", "pdf", "print", "colvis"]
