        ...
        <table id="example" class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button value="{{$p->id_pengaduan}}" class="btn btn-primary btn-info-laporan"  data-bs-target="#modal-laporan" uri="{{url('getsinglepengaduan')}}"><i class="fa fa-file"></i></button>
