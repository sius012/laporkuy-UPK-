            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button value="{{$p->id_pengaduan}}" data-bs-toggle="modal" data-bs-target="#modal-penugasan" class="btn btn-success btn-assigment" uri="{{url('getsinglepengaduan')}}"><i class="fa fa-users"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
