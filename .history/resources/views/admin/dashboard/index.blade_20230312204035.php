    ...
    <div class="row">
        <div class="col">
            <div class="small-box bg-success">
                ...
                <a href="/admin/datapengaduan?status=Menunggu" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col">
            <div class="small-box bg-warning">
                ...
                <a href="/admin/datapengaduan?status=Ke petugas:Diproses:Ditunda" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col">
            <div class="small-box bg-info">
                ...
                <a href="/admin/datapengaduan?status=Selesai" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col">
            <div class="small-box bg-danger ">
                ...
                <a href="/admin/datapengaduan?status=Dibatalkan" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
