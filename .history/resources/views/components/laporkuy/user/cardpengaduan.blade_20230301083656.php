<div class="card">
    <div class="card-header">
       <b>{{ucwords($pn->judul_pengaduan)}} : {{$pn->jenis->jenis}}</b>
    </div>
    <div class="card-body">
        <div class="row">
    ...
    <div class="card-footer">
        <button class="btn btn-primary-lk  btn-lampiran" value="{{$pn->id_}}" state="before" data-toggle="modal" data-target="#modal-lampiran"><i class="fa fa-image"></i></button>
    </div>
</div>