<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-2"><img style="width: 50px" src="https://st3.depositphotos.com/6672868/13701/v/600/depositphotos_137014128-stock-illustration-user-profile-icon.jpg" class="rounded-circle shadow-sm m-auto" alt=""></div>
            <div class="col-sm-10">
