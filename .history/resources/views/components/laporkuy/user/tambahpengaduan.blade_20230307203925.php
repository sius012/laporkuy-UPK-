<div class="modal fade" id="tambahpengaduan-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form action="{{route('pengaduan.buat.user')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="" class="form-control" name="id_jenis" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control-file" id="lampiranLabel" name="lampiran[]" multiple required>
                    </div>
