<div class="modal fade" tabindex="-1" role="dialog" id="modal-penugasan">
    <div class="modal-dialog modal-lg" role="document">
        <form  url="{{url("admin")}}" action="{{route('admin.assignpetugas')}}" method="post" id="penugasan-form">
        @csrf
        <input type="hidden" name="id_pengaduan" id="id_pengaduan">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-petugas-judul">Tambahkan Petugas</h5>
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    ...
                    <textarea required name="keterangan_admin" id="modal-petugas-keteranganadmin" cols="30" rows="10" class="form-control"></textarea>
                </div>
