        ...
        <div class="col-md-4 m-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                            <input id="password" type="password" placeholder="Pass" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
