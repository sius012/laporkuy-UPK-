...
<script>
    $(document).ready(function(){
       $(".btn-edit").click(function(){
            ...
            if(elementinput.attr("required") != undefined){
                elementinput.attr("required","required");
                elementinput.attr('class',"form-control-textplaint");
            }else{
                elementinput.attr('class',"form-control");
                elementinput.removeAttr("required");
