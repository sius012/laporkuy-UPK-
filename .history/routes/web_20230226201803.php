...
Route::get('/laporansaya', [App\Http\Controllers\Masyarakat\MasyarakatController::class, "pengaduansaya"])->name("pengaduan.list.user");
...
Route::get('/pengaturanpengguna', [\App\Http\Controllers\Admin\PengaturanAkunController::class,"index"])->name("pengaturan.pengguan")
