...
Route::group(['middleware'=>['role:Admin|Masyarakat']], function(){
    ...
    Route::get('/pengaturanpengguna', [\App\Http\Controllers\Admin\PengaturanProfilController::class,"index"])->name("pengaturan.pengguna");
});
...
Route::get('profil', [\App\Http\Controllers\PengaturanAkunController::class, "index"])->name('pengaturan.profile');
