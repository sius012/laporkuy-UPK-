...
Route::group(['middleware'=> ["role:Admin"],"prefix"=>"admin"], function(){
    ...
    Route::post('/deletepengaduan', [\App\Http\Controllers\PengaduanController::class, "deletepengaduan"])->name('admin.deletepengaduan');
    ...
    Route::post('/tambahjenispengaduan', [\App\Http\Controllers\Admin\JenisPengaduanController::class,"buat"])->name('jenispengaduan.buat');
...
Route::middleware('auth')->group(function () {
    Route::get('/getnotifications', [\App\Http\Controllers\MasterController::class, "getnotifications"])->name("master.getnotifications");
    Route::patch('/profile', [ProfileController::class, 'update'])->name('profile.update');
    Route::delete('/profile', [ProfileController::class, 'destroy'])->name('profile.destroy');
    Route::get('/hasread', [MasterController::class,"hasread"]);
});
